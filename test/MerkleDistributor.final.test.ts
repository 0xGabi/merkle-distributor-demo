...
describe.skip('MerkleDistributor', () => {
  ...
  before(async () => {
    ...
    Distributor = await artifacts.readArtifact('MerkleDistributor')
  })
  ...
  describe('#claim', () => {
    ...
    describe('two account tree', () => {
      ...
      it('successful claim', async () => {
        ...
        const claim = await distributor.claim(0, addresses[0], BigNumber.from(100), proof0, overrides)
        await expect(claim).to.emit(distributor, 'Claimed').withArgs(0, addresses[0], 100)
